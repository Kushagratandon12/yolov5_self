                ...
                if plots and ni < 3:
                    ...
                    if loggers['tb'] and ni == 0:  # TensorBoard
                        with warnings.catch_warnings():
                            ...
                            loggers['tb'].add_graph(torch.jit.trace(
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str,
                        default='dataset/data.yaml', help='dataset.yaml path')
    parser.add_argument(
    ...
    parser.add_argument('--img-size', nargs='+', type=int,
                        default=[1024, 1024], help='[train, test] image sizes')
    ...
    parser.add_argument('--bucket', type=str,
                        default='true', help='gsutil bucket')
...
def main(opt):
    ...
    if LOCAL_RANK != -1:
        ...
        ) else "gloo", timeout=timedelta(seconds=60))
